        ...
        <UCard>
            ...
            <div class="space-y-4">
                ...
                <div v-if="images.length > 0" class="relative">
                    ...
                    <!-- 图片索引指示器 -->
                    <div
                        class="bg-opacity-50 absolute bottom-2 left-1/2 -translate-x-1/2 transform rounded-full bg-black px-3 py-1 text-sm text-white"
                    >
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <div class="flex space-x-1">
                        ...
                        >
                            <UIcon :name="tab.icon" class="mr-1 inline-block" />
                            {{ tab.label }}
                        </button>
                    </div>
                </div>
                ...
                <div class="py-4">
                    ...
                    <div v-if="activeTab === 'auto'" class="space-y-4">
                        <p class="text-sm text-gray-600">根据笔记内容自动生成匹配的配图</p>
                        <UButton
                            block
                            size="lg"
                    ...
                    <div v-if="activeTab === 'template'">
                        ...
                        <div
                            v-else-if="imageTemplates.length === 0"
                        ...
                        <div v-else class="grid grid-cols-3 gap-3">
                            <div
                                ...
                                :key="template.id"
                                class="hover:ring-primary aspect-square cursor-pointer overflow-hidden rounded-lg bg-gray-100 transition-all hover:ring-2"
                    ...
                    <div v-if="activeTab === 'history'">
                        ...
                        <div
                            v-else-if="historyImages.length === 0"
                            class="py-8 text-center text-gray-500"
                        >
                            暂无历史图片
                        </div>
                    ...
                    <div v-if="activeTab === 'upload'" class="space-y-4">
                        ...
                        >
                            ...
                            <UIcon
                                ...
                                class="mx-auto mb-3 text-4xl text-gray-400"
                            />

                            <p class="mb-2 text-sm text-gray-600">拖拽图片到此处，或</p>
